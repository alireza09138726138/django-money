...
SECRET_KEY = 'a+bv=ck-yg%$0q0=-pi2(mm9n=5e(*(p_ri=0&^v(_&!pi^ox$'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'djangobin.context_processors.recent_snippet',
...
# https://docs.djangoproject.com/en/1.10/howto/static-files/  SECRET_KEY 
...
ADMINS = [
    ('OverIQ', 'alirezamosavi346@gmail.com'),
]
